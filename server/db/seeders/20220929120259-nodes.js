    ...
    */
    await queryInterface.bulkInsert('Nodes', [
      ...
      },
      {
        ...
        Надеть скафандр, осмотреть ракету -- 2
        Перекусить и подумать -- 3`,
        project_id: 2,
        isFirst: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        Устранить самостоятельно – 4
        Вернуться в ракету и подумать -- 3`,
        project_id: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        Развернуть ракету к полюсу Галактики – 5
        Надеть скафандр, осмотреть ракету -- 2`,
        project_id: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        Вернуться в ракету и подумать – 2
        Попытаться поймать ключ -- 6`,
        project_id: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        Выйти из Vortex Gravitatiosus Pinckenbachii – 6
        Продолжать маневр -- 7`,
        project_id: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
