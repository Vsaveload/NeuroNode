  ...
  async up(queryInterface, Sequelize) {
    ...
    */
    await queryInterface.bulkInsert('Nodes', [
      ...
      {
        name: 'Бежаааать!',
        content: `Вы бросаете папку и бежите сломя голову в темноту. К сожалению вы так и не научились видеть в темноте: пронесясь 5 метров , вы ударяетесь о стену и резко просыпаетесь:
        Секундой ранее:
        "Ну что? Бахнем и пойдем?" Хлоп. Конец`,
        project_id: 3,
        isFirst: false,
        createdAt: new Date(),
        updatedAt: new Date(),
